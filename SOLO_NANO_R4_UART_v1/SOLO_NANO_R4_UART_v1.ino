...
static constexpr uint32_t SOLO_UART_TIMEOUT_MS = 8;
static constexpr uint8_t SOLO_UART_PACKET_RETRIES = 1;
...
void loop()
{
  ...
  // Normal UART traffic follows one 25 ms slotted schedule. The dedicated
